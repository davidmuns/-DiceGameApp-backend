...
public class JugadorController {
	...
	if (optionalJugador.isPresent() && existe == false && !jugador.getNombre().isBlank()) {
	    ...
	    return ResponseEntity.ok(jugadorDto);
	    // return ResponseEntity.ok("Jugador actualizado. Nombre nuevo: " +
	    // actualizarJugador.getNombre());
	}
	...
	List<JugadorDto> jugadoresDto = iUtilities.getRankingOrdenadoByRatio(iJugadorService.getAllJugadores());
